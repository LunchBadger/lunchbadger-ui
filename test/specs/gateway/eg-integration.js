...
module.exports = {
  ...
  'EG integration: conditions change': function () {
    page
      .setConditionName(0, 1, 0, '', 5, 'hostMatch')
      ...
      .setConditionName(0, 1, 5, 'e', 1, 'pathExact')
      .setConditionParameter(0, 1, 5, 'path', '/exact')
      .setConditionName(0, 1, 10, 'e', 1, 'pathExact')
  ...
  'EG integration: add allOf conditions': function () {
    page
      ...
      .addSubCondition(0, 1, 0)
      .setConditionName(0, 1, 0, 'e', 1, 'pathExact', 'conditions2')
      .setConditionParameter(0, 1, 0, 'path', '/a', 'conditions2')
      .addSubCondition(0, 1, 0)
      .setConditionName(0, 1, 0, '', 5, 'hostMatch', 'conditions3')
  ...
  'EG integration: edit allOf conditions': function () {
    page
      .addSubCondition(0, 1, 0)
      .setConditionName(0, 1, 0, 'e', 1, 'pathExact', 'conditions4')
      ...
      .addSubCondition(0, 1, 0, 'conditions1')
      .setConditionName(0, 1, 0, 'e', 1, 'pathExact', 'conditions1conditions1')
      .setConditionParameter(0, 1, 0, 'path', '/afterAlways', 'conditions1conditions1')
      .setConditionName(0, 1, 0, 'e', 1, 'pathExact', 'conditions1conditions2')
