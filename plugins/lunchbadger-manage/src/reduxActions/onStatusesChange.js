  ...
  Object.keys(entries).forEach(async (slugId) => {
    ...
    if (status === null) {
      ...
      if (entity === null) {
        ...
        if (updatedEntity.id === 'autogenerated'
          && updatedEntity.pipelines[0].policies.length === 0
        ) {
          try {
        ...
        if (entity.id === 'autogenerated'
          && !Object.keys(state.entities.apiEndpoints)
            .includes('autogeneratedApiEndpoint')
        ) {
