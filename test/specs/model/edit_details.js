...
var detailsPanelSelector = '.panel__container .panel__body.details';
...
module.exports = {
  ...
  'Model: edit panel details': function (browser) {
    ...
    page.setValue(detailsPanelSelector + ' .details-panel__element .details-panel__fieldset .details-panel__input input', 'Changed');
    browser.pause(1000);
