...
module.exports = {
  ...
  'Datasource: rest': function (browser) {
    ...
    page
      ...
      .clickVisible('.DetailsPanel .button__add__operation')
      ...
      .clickVisible('.DetailsPanel .checkbox__optionsenabled')
      .clickVisible('.DetailsPanel .checkbox__optionsstrictSSL')
      .clickVisible('.DetailsPanel .checkbox__optionsuseQuerystring')
      .clickVisible('.DetailsPanel .checkbox__optionsheadersenabled')
      ...
      .clickVisible('.DetailsPanel .checkbox__operations0templateoptionsuseQuerystring')
      ...
      .clickVisible('.DetailsPanel .checkbox__optionsstrictSSL')
      .clickVisible('.DetailsPanel .checkbox__optionsuseQuerystring')
      .clickVisible('.DetailsPanel .button__remove__optionsHeadersParameter0')
      .clickVisible('.DetailsPanel .button__add__optionsHeadersParameter')
      ...
      .clickVisible('.DetailsPanel .checkbox__optionsheadersenabled')
      .clickVisible('.DetailsPanel .button__remove__operation1')
      .clickVisible('.DetailsPanel .checkbox__operations0templateoptionsenabled')
      .clickVisible('.DetailsPanel .button__remove__operation0headersParameter0')
      .clickVisible('.DetailsPanel .button__remove__operation0queryParameter0')
      .clickVisible('.DetailsPanel .button__remove__operation0function0')
